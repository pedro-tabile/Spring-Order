...
public class ClientRestController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Client> update(@RequestBody ClientRequestDTO clientRequestDTODTO, @PathVariable Long id){
        return ResponseEntity.ok(clientService.update(clientRequestDTODTO, id));
    }
    ...
    @PostMapping
    public ResponseEntity<Client> insert(@RequestBody ClientRequestDTO clientRequestDTODTO){
        return ResponseEntity.ok(clientService.insert(clientRequestDTODTO));
    }
}
